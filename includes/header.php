...
<head>
    ...
    <!-- jQuery CDN for Real-Time AJAX Updates -->
                    ...
                    <div class="dropdown">
                        <div class="header-profile dropdown-trigger">
                            <div class="header-profile-info">
                                ...
                                <div class="header-profile-role"><?= $currentRole === ROLE_STUDENT ? 'Student' : ((isset($_SESSION['admin_role']) && $_SESSION['admin_role'] === 'super_admin') ? 'Head Admin' : 'Administrator') ?></div>
                            </div>
